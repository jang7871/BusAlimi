		...
		contentType: 'application/json; charset=UTF-8',
   		...
   		success:function(obj){
			...
			$.each(obj, function(index, item) {
				...
				tag += '<div class="w3-col w3-white w3-margin-bottom w3-hover-pale-yellow w3-border-bottom startdatalist" id="'+ item.station_id +'" style="cursor: pointer;">';
				tag += '	<div class="w3-col w3-padding">';
				tag += '		<div class="w3-col w3-border-bottom w3-border-blue w3-text-gray">'+ item.region +'</div>';
				tag += '		<div class="w3-col" style="padding-top: 5px;">';
				tag += '			<div class="w3-col">';
		...
		contentType: 'application/json; charset=UTF-8',
   		...
   		success:function(obj){
			...
			$.each(obj, function(index, item) {
				...
				tag += '<div class="w3-col w3-white w3-margin-bottom w3-hover-pale-yellow w3-border-bottom enddatalist" id="'+ item.station_id +'" style="cursor: pointer;">';
				tag += '	<div class="w3-col w3-padding">';
				tag += '		<div class="w3-col w3-border-bottom w3-border-blue w3-text-gray">'+ item.region +'</div>';
				tag += '		<div class="w3-col" style="padding-top: 5px;">';
				tag += '			<div class="w3-col">';
